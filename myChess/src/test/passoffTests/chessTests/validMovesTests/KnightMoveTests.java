...
public class KnightMoveTests {
    ...
    public void emptyBoard(){
		...
		| | | | | | | | |
         */
        ChessPiece horse = getNewPiece(WHITE, KNIGHT);
        board.addPiece(midBoard, horse);
        game.setBoard(board);
		...
		| | | | | | | | |
         */
        horse = getNewPiece(BLACK, KNIGHT);
        board.addPiece(midBoard, horse);
        game.setBoard(board);
        assertEquals(baseMoves, game.validMoves(midBoard));
    }
    ...
    public void boardEdge(){
        ...
        horse = getNewPiece(WHITE, KNIGHT);
        board = getNewBoard();
        board.addPiece(edge, horse);
        moves = new HashSet<>();
