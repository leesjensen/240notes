...
public class ComplexMoveTests {
    ...
    public void knightForcedMove(){
        ...
        Set<ChessMove> validMoves = new HashSet<>();
        ChessPiece horse = getNewPiece(BLACK, KNIGHT);
        ChessPosition horsePosition = getNewPosition(4,3);
        chessBoard.addPiece(horsePosition, horse);
        ...
        validMoves.add(getNewMove(horsePosition, getNewPosition(3,5), null));  //defend king
        validMoves.add(getNewMove(horsePosition, getNewPosition(6,2), null)); //capture bishop

        game.setBoard(chessBoard);
        assertEquals(validMoves, game.validMoves(horsePosition));
    }
